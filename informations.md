...
<p>
Εάν διαθέτετε :    
✨ Φωτογραφικό Υλικό (πρωτότυπες φωτογραφίες). 
✨ Προσωπικά Έγγραφα (π.χ., επιστολές, πιστοποιητικά).
✨ Βιογραφικά Στοιχεία (για επιβεβαίωση/εμπλουτισμό)</p>
    
#### Η συμβολή σας στην ιστορική τεκμηρίωση του έργου μας θα είναι **ανεκτίμητη**! 

<p> Επιλέξτε τον τρόπο επικοινωνίας που σας εξυπηρετεί.</p>

---

## 1. 📧 Άμεση Επικοινωνία & Υποβολή Κειμένου

<div class="email-box">
  📧 Αποστολή μέσω Email 
  <p>
    Για άμεση επικοινωνία ή ερωτήσεις, παρακαλούμε χρησιμοποιήστε την επίσημη διεύθυνση της ομάδας:
  </p>
...
<div class="upload-box">
  🖼️ Υποβολή Φωτογραφικού Υλικού & Εγγράφων / Αποστολή Μεγάλων Αρχείων (Google Drive)
  <p>
  ...
  <p style="margin-top: 15px; font-size: 0.9em; color: #888;">
    (Ανοίγει σε νέα καρτέλα - Απαιτεί λογαριασμό Google/Dropbox)
  </p>
</div>
